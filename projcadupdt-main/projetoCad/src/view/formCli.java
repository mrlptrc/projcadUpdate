...
public class formCli extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(6, 398, 530, 187);
    ...
    private void btnIncluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIncluirMouseClicked
        ...
        ResultSet resul = ud.buscar(u1);
        try { if ( resul.next() ) { // caso exista o cpf então chama u1.alterar()
        ud.alterar(u1);
        } else {
        ud.incluir(u1);// caseo não exista o cpf chama u1.incluir()
    ...
    int linhasel = this.tableCli.getSelectedRow(); // captura o numero da linha selecionada
    int colunachave = 0; // pega sempre o numero da coluna 0
    Object chave = this.tableCli.getModel().getValueAt( linhasel, colunachave);
    ...
    } else { JOptionPane.showMessageDialog(null, "Registro não encontrado!");
    this.textCpf.grabFocus(); }
    } catch (SQLException err) { JOptionPane.showMessageDialog(null, "Erro ao navegarna Jtable! "); 
    }
